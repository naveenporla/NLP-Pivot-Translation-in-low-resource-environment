...
checkpoint_path = "Models/Tanzil/100k/seq_az_en_100k.pth.tar"
last_checkpoint = "Models/Tanzil/100k/seq_last_az_en_100k.pth.tar"
...
#checkpoint_path = 'Models/Tanzil/200k/seq_az_tr_200k.pth.tar'
#last_checkpoint = 'Models/Tanzil/200k/seq_last_az_tr_200k.pth.tar'
#train_dataset_path = 'Datasets/Tanzil/az_tr_train200k.csv'
#test_dataset_path = 'Datasets/Tanzil/az_tr_test200k.csv'
#set_source_to = "azerbaijani"     #to setup tokenizer
#set_target_to = "turkish"     #to setup tokenizer


#checkpoint_path = "Models/Tanzil/200k/seq_tr_en_200k_2.pth.tar"
#last_checkpoint = "Models/Tanzil/200k/seq_each_tr_en_200k.pth.tar"
...
#translation_input_path = "Outputs/Tanzil/tl_az_tr_turk_20k_split.txt"
##translation_input_path = "Outputs/Tanzil/tl_az_tr_turk_20k_split.txt"
#translation_output_path = "Outputs/Tanzil/tl_tr_en_eng_20k_split.txt"
#
#Translate_testdata(translation_input_path,translation_output_path,model, source_lang, target_lang, device,max_length=50)
#
#bleu_Score = cust_bleu(translation_output_path, "Testset/Tanzil/eng_20k_split.txt")
#print(f"Custom Bleu score {bleu_Score*100:.3f}")



######  Training loss and Bleu plot data ######
#with open("Outputs/Tanzil/tl_az_tr_plotdata.txt", 'w',encoding='utf-8') as op:
